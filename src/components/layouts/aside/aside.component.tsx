    ...
    return (
        <aside className={classnames(styles.aside, { [styles.asideActive]: asideOpen })}>
            ...
            <div className={styles.asideInformation}>
                ...
                <a href='https://www.linkedin.com/posts/parag-agarwal-192896219_my-cv-activity-7099472279276797952-5Cs-?utm_source=share&utm_medium=member_desktop' className={styles.asideInformationCV}>
                    <CgSoftwareDownload />
